...
A mesmerizing, interactive canvas animation of circles cascading down tightly-packed columns. Built with **TypeScript**, HTML, and CSS — no runtime dependencies.
...
├── app.js              – Compiled output (generated by `npm run build`, not committed)
...
The project requires a build step to compile TypeScript sources.
